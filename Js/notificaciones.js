document.addEventListener('DOMContentLoaded', function () {
    const notificationData = {
        aprobacion: {
            ...
            description: 'Tu reporte RPT-20260419-1432 de la categoria Vehiculo en la banqueta fue revisado correctamente. La evidencia fue suficiente y el incidente paso a estado cerrado.',
            date: '19 de abril, 2026 - hace 12 minutos',
            category: 'Vehiculo en la banqueta',
            action: 'Se acreditaron 37 puntos a tu saldo y el folio quedo archivado en tu historial.',
            details: [
        ...
        evidencia: {
            ...
            description: 'El equipo detecto que una de las fotografias no muestra con claridad la placa y solicita una imagen adicional para continuar con el proceso.',
            date: '19 de abril, 2026 - hace 1 hora',
            category: 'Vehiculo en zona de discapacitados',
            action: 'Se recomienda subir una nueva fotografia desde tu reporte para evitar que el caso sea pausado.',
            details: [
        ...
        recompensa: {
            ...
            description: 'Tu reporte de la categoria Vehiculo en la ciclovia fue cerrado correctamente. Los puntos generados ya impactaron tu saldo y desbloquearon una nueva recompensa.',
            date: '19 de abril, 2026 - 9:40 a. m.',
            category: 'Vehiculo en la ciclovia',
            action: 'Puedes ir a la seccion de recompensas para revisar condiciones, puntos requeridos y disponibilidad.',
            details: [
        ...
        recordatorio: {
            ...
            description: 'Aun tienes un reporte abierto en la categoria Vehiculo abandonado en la calle. El sistema te recuerda dar seguimiento para no perder continuidad en el proceso.',
            date: '18 de abril, 2026 - 6:15 p. m.',
            category: 'Vehiculo abandonado en la calle',
            action: 'Consulta el historial para revisar los casos abiertos y verificar si alguno necesita una respuesta de tu parte.',
            details: [
