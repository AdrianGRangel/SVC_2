document.addEventListener('DOMContentLoaded', function () {
    const historyData = {
        banqueta: {
            ...
            description: 'El caso sigue abierto y fue actualizado con evidencia complementaria para reforzar la validacion del incidente.',
            date: '19 de abril, 2026 - 2:32 p. m.',
            category: 'Vehiculo en la banqueta',
            action: 'Esperar la revision final del equipo. Si solicitan mas informacion, el sistema te notificara.',
            details: [
        ...
        abandonado: {
            ...
            description: 'El equipo municipal atendio el incidente y el reporte fue cerrado satisfactoriamente dentro del sistema.',
            date: '17 de abril, 2026 - 11:08 a. m.',
            category: 'Vehiculo abandonado en la calle',
            action: 'No se requiere ninguna accion adicional. El caso ya forma parte de tu historial cerrado.',
            details: [
        ...
        discapacitados: {
            ...
            description: 'El reporte necesita una comprobacion manual adicional antes de poder avanzar a cierre o aprobacion final.',
            date: '15 de abril, 2026 - 5:20 p. m.',
            category: 'Vehiculo en zona de discapacitados',
            action: 'Mantente atento a nuevas notificaciones por si el equipo solicita mas evidencia o una aclaracion.',
            details: [
        ...
        ciclovia: {
            ...
            status: 'Cerrado',
            statusClass: 'status-success',
            description: 'El reporte fue concluido correctamente y los creditos correspondientes ya se reflejan en tu balance.',
            date: '12 de abril, 2026 - 8:54 a. m.',
            category: 'Vehiculo en la ciclovia',
            action: 'Puedes revisar tu saldo en recompensas o continuar generando nuevos reportes.',
            details: [
